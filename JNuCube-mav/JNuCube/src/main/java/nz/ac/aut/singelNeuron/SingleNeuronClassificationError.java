 ...
 */
package nz.ac.aut.singelNeuron;
...
import nz.ac.aut.optimisation.fitnessFunctions.FitnessFunction;
...
import nz.ac.aut.spikingNeurons.cores.CoreConstants;
...
public class SingleNeuronClassificationError extends FitnessFunction {
     ...
     * {@link #runExperiment(ArrayList, ArrayList)}
     *
     */
     ...
     * calls the {@link #propagateSample(nz.ac.aut.data.DataSample)} function.
     *
